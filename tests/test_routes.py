...
class TestRecommendationService(TestCase):
    ...
    def test_get_recommendation(self):
        ...
        self.assertEqual(retrieved_recommendation["user_id"], test_recommendation.user_id)
        self.assertEqual(retrieved_recommendation["product_id"], test_recommendation.product_id)
        self.assertAlmostEqual(retrieved_recommendation["score"], test_recommendation.score, places=2)
    ...
    def test_get_recommendation_not_found(self):
        ...
        response = self.client.get(f"{BASE_URL}/9999")  # 9999 is an arbitrary non-existent ID
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
